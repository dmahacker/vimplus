...
autocmd FileType javascript set dictionary=$VIM/vimfiles/dict/js.dict
autocmd FileType wxml setlocal shiftwidth=2
autocmd FileType wxml setlocal tabstop=2
autocmd FileType wxml set dictionary=$VIM/vimfiles/dict/wxml.dict
autocmd FileType wxss setlocal shiftwidth=2
autocmd FileType wxss setlocal tabstop=2
